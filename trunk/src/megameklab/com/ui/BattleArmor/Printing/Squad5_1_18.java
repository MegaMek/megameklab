...
((GeneralPath)shape).curveTo(373.13, 643.146, 371.959, 641.973, 371.959, 640.527);
((GeneralPath)shape).curveTo(371.959, 639.07996, 373.13, 637.90796, 374.57602, 637.90796);
((GeneralPath)shape).curveTo(376.023, 637.907, 377.195, 639.079, 377.195, 640.527);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.5057f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(384.195, 640.527);
((GeneralPath)shape).curveTo(384.195, 641.97296, 383.023, 643.146, 381.57602, 643.146);
((GeneralPath)shape).curveTo(380.13, 643.146, 378.959, 641.973, 378.959, 640.527);
((GeneralPath)shape).curveTo(378.959, 639.07996, 380.13, 637.90796, 381.57602, 637.90796);
((GeneralPath)shape).curveTo(383.023, 637.907, 384.195, 639.079, 384.195, 640.527);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
