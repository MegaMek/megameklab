 ...
 * >SVGRoundTrip</a>.
 */
public class Armor_CT_49_Humanoid {
    /**
    ...
    public static void paint(Graphics2D g) {
        ...
        ((GeneralPath) shape).curveTo(498.14297, 190.214, 499.24, 189.116,
                499.24, 187.79901);
        ((GeneralPath) shape).curveTo(499.24, 186.48302, 498.143, 185.38501,
                496.826, 185.38501);
        ((GeneralPath) shape).curveTo(495.50998, 185.38501, 494.414, 186.48302,
                494.414, 187.79901);
        ((GeneralPath) shape).curveTo(494.414, 189.116, 495.51, 190.214,
                496.826, 190.214);
        ...
        ((GeneralPath) shape).curveTo(487.359, 190.214, 488.456, 189.116,
                488.456, 187.79901);
        ((GeneralPath) shape).curveTo(488.456, 186.48302, 487.359, 185.38501,
                486.039, 185.38501);
        ((GeneralPath) shape).curveTo(484.723, 185.38501, 483.627, 186.48302,
                483.627, 187.79901);
        ((GeneralPath) shape).curveTo(483.627, 189.116, 484.723, 190.214,
                486.039, 190.214);
