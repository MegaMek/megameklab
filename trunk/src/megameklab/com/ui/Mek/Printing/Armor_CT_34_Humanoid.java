 ...
 */
public class Armor_CT_34_Humanoid {
    /**
...
((GeneralPath)shape).curveTo(493.848, 107.113, 492.824, 106.015, 491.436, 106.015);
((GeneralPath)shape).curveTo(490.11902, 106.015, 489.019, 107.113, 489.019, 108.429);
