 ...
 */
public class Armor_RLeg_1_Humanoid {
    /**
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(532.747, 241.283);
((GeneralPath)shape).curveTo(534.31, 240.894, 535.271, 239.29901, 534.864, 237.664);
((GeneralPath)shape).curveTo(534.472, 236.102, 532.87604, 235.143, 531.313, 235.533);
((GeneralPath)shape).curveTo(529.68396, 235.938, 528.722, 237.53601, 529.114, 239.09601);
((GeneralPath)shape).curveTo(529.521, 240.731, 531.118, 241.689, 532.747, 241.283);
((GeneralPath)shape).lineTo(532.747, 241.283);
