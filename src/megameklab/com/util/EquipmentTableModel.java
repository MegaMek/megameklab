...
public class EquipmentTableModel extends AbstractTableModel {
    ...
    public static final int COL_DAMAGE = 1;
    public static final int COL_DIVISOR = 2;
    public static final int COL_SPECIAL = 3;
    public static final int COL_HEAT = 4;
    public static final int COL_MRANGE = 5;
    public static final int COL_RANGE = 6;
    public static final int COL_SHOTS = 7;
    public static final int COL_TECH = 8;
    public static final int COL_TLEVEL = 9;
    public static final int COL_TRATING = 10;
    public static final int COL_DPROTOTYPE = 11;
    public static final int COL_DPRODUCTION = 12;
    public static final int COL_DCOMMON = 13;
    public static final int COL_DEXTINCT = 14;
    public static final int COL_DREINTRO = 15;
    public static final int COL_COST = 16;
    public static final int COL_CREW = 17;
    public static final int COL_BV = 18;
    public static final int COL_TON = 19;
    public static final int COL_CRIT = 20;
    public static final int COL_REF = 21;
