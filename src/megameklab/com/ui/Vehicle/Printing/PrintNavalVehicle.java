...
public class PrintNavalVehicle implements Printable {
    ...
    public void printImage(Graphics2D g2d, PageFormat pageFormat) {
        ...
        // g2d.drawImage(ImageHelper.getRecordSheet(sub, false), 18, 18, 558, 736,
        // null);
        try {
        ...
        try {
            ImageHelper
                    .loadSVGImage(new File(
                            "data/images/recordsheets/Naval_Left_Armor_" + sub.getArmor(Tank.LOC_LEFT) + ".svg"))
                    .render(g2d);
            ImageHelper
                    .loadSVGImage(new File(
                            "data/images/recordsheets/Naval_Rear_Armor_" + sub.getArmor(Tank.LOC_REAR) + ".svg"))
                    .render(g2d);
            ImageHelper
                    .loadSVGImage(new File(
                            "data/images/recordsheets/Naval_Front_Armor_" + sub.getArmor(Tank.LOC_FRONT) + ".svg"))
                    .render(g2d);
            ImageHelper
                    .loadSVGImage(new File(
                            "data/images/recordsheets/Naval_Right_Armor_" + sub.getArmor(Tank.LOC_RIGHT) + ".svg"))
                    .render(g2d);
            if (!sub.hasNoTurret()) {
                ImageHelper.loadSVGImage(new File(
                        "data/images/recordsheets/Naval_Turret_Armor_" + sub.getArmor(Tank.LOC_TURRET) + ".svg"))
                        .render(g2d);
            }
            ImageHelper
                    .loadSVGImage(
                            new File("data/images/recordsheets/Naval_IS_" + sub.getInternal(Tank.LOC_LEFT) + ".svg"))
                    .render(g2d);

            if (!sub.hasNoTurret()) {
                ImageHelper.loadSVGImage(new File(
                        "data/images/recordsheets/Naval_TURRET_IS_" + sub.getInternal(Tank.LOC_TURRET) + ".svg"))
                        .render(g2d);
            }
        ...
        /*
         * printFrontArmor(g2d, sub.getOArmor(Tank.LOC_FRONT), false,
         * sub.hasModularArmor(Tank.LOC_FRONT)); printLeftArmor(g2d,
         * sub.getOArmor(Tank.LOC_LEFT), false, sub.hasModularArmor(Tank.LOC_LEFT));
         * printRightArmor(g2d, sub.getOArmor(Tank.LOC_RIGHT), false,
         * sub.hasModularArmor(Tank.LOC_RIGHT)); printRearArmor(g2d,
         * sub.getOArmor(Tank.LOC_REAR), false, sub.hasModularArmor(Tank.LOC_REAR));
         * printTurretArmor(g2d, sub.getOArmor(Tank.LOC_TURRET), false,
         * sub.hasModularArmor(Tank.LOC_TURRET));
         */
    ...
    private void printTankData(Graphics2D g2d) {
        ...
        /*
         * if ((sub.getCrew() != null) &&
         * !sub.getCrew().getName().equalsIgnoreCase("unnamed")) { Crew pilot =
         * sub.getCrew(); g2d.drawString(pilot.getName(), 270+leftmargin, topmargin+117)
         * ; g2d.drawString(String.valueOf(pilot.getGunnery()), 295+leftmargin,
         * topmargin+132) ; g2d.drawString(String.valueOf(pilot.getPiloting()),
         * 365+leftmargin, topmargin+132) ; }
         */
        ...
        if (!sub.hasWorkingMisc(MiscType.F_MASC, MiscType.S_SUPERCHARGER)) {
            ...
            g2d.drawString(Integer.toString(sub.getRunMPwithoutMASC()) + " [" + mascMP + "]", 79 + leftmargin,
                    topmargin + 154);
        }
        ...
        // g2d.drawString(Integer.toString(sub.getYear()), 188+leftmargin,
        // topmargin+155) ;
        ...
        if (bv != -1) {
            ...
            g2d.setFont(font);
            g2d.drawString(String.format("%1$,d", sub.calculateBattleValue(true, true)), 45 + leftmargin,
                    topmargin + 368);
        }
    ...
    private void printArmor(Graphics2D g2d) {
        ...
        g2d.setFont(font);
        ImageHelper.printCenterString(g2d, ImageHelperVehicle.getVehicleArmorTypeString(sub), g2d.getFont(),
                478 + leftmargin, topmargin + 48);
        // g2d.drawString(ImageHelperVehicle.getVehicleArmorTypeString(sub),
        // 463+leftmargin, topmargin+48);
        font = UnitUtil.deriveFont(true, 9.0f);
        g2d.setFont(font);

        g2d.drawString(Integer.toString(sub.getArmor(Tank.LOC_FRONT)), 476 + leftmargin, topmargin + 55.f);
        ImageHelper.printRotatedText(g2d, Integer.toString(sub.getArmor(Tank.LOC_RIGHT)), 90, 568 + leftmargin,
                topmargin + 374);
        ImageHelper.printRotatedText(g2d, Integer.toString(sub.getArmor(Tank.LOC_LEFT)), 270, 397 + leftmargin,
                topmargin + 316);
    ...
    private void printTurretStruct(Graphics2D g2d, int totalArmor, boolean secondImage) {
        ...
        float[] leftStart = new float[] { 447, 287 };
        float[] leftEnd = new float[] { 447, 342 };
        float[] midStart = new float[] { 454, 287 };
        float[] midEnd = new float[] { 454, 342 };
        float[] rightStart = new float[] { 461, 287 };
        float[] rightEnd = new float[] { 461, 342 };
