...
public class PrintVehicle implements Printable {
    ...
    public PrintVehicle(ArrayList<Tank> list, boolean singlePrint, PrinterJob masterPrintJob) {
        tankList = list;
    ...
    private void printTank2Data(Graphics2D g2d) {
        ...
        // DecimalFormat myFormatter = new DecimalFormat("#,###",
        // unusualSymbols);
        g2d.drawString(String.format("%1$,d", tank2.calculateBattleValue(true, true)), 150, 357 + secondPageMargin);
