 ...
 * >SVGRoundTrip</a>.
 */
public class SuperHeavyNoTurretTemplate {
    /**
    ...
    public static void paint(Graphics2D g) {
        ...
        paint = new Color(35, 31, 32, 255);
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(258.712, 207.321);
        ((GeneralPath) shape).lineTo(258.712, 209.138);
        ((GeneralPath) shape).lineTo(261.414, 209.138);
        ((GeneralPath) shape).lineTo(261.414, 209.646);
        ((GeneralPath) shape).lineTo(258.712, 209.646);
        ((GeneralPath) shape).lineTo(258.712, 211.638);
        ((GeneralPath) shape).lineTo(261.53, 211.638);
        ((GeneralPath) shape).lineTo(261.53, 212.146);
        ((GeneralPath) shape).lineTo(258.111, 212.146);
        ((GeneralPath) shape).lineTo(258.111, 206.813);
        ((GeneralPath) shape).lineTo(261.53, 206.813);
        ((GeneralPath) shape).lineTo(261.53, 207.321);
        ((GeneralPath) shape).lineTo(258.712, 207.321);
        g.setPaint(paint);
        g.fill(shape);
        ...
        paint = new Color(35, 31, 32, 255);
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(262.276, 208.411);
        ((GeneralPath) shape).lineTo(262.801, 208.411);
        ((GeneralPath) shape).lineTo(262.785, 208.91899);
        ((GeneralPath) shape).lineTo(262.801, 208.93098);
        ((GeneralPath) shape).curveTo(262.96698, 208.54799, 263.38, 208.35698,
                264.041, 208.35698);
        ((GeneralPath) shape).curveTo(264.573, 208.35698, 264.934, 208.45097,
                265.123, 208.63799);
        ((GeneralPath) shape).curveTo(265.31097, 208.82599, 265.405, 209.18498,
                265.405, 209.71599);
        ((GeneralPath) shape).lineTo(265.405, 212.14598);
        ((GeneralPath) shape).lineTo(264.859, 212.14598);
        ((GeneralPath) shape).lineTo(264.859, 209.62299);
        ((GeneralPath) shape).curveTo(264.859, 209.30298, 264.798, 209.08798,
                264.676, 208.97598);
        ((GeneralPath) shape).curveTo(264.555, 208.86699, 264.319, 208.80998,
                263.97, 208.80998);
        ((GeneralPath) shape).curveTo(263.204, 208.80998, 262.82, 209.17299,
                262.82, 209.89899);
        ((GeneralPath) shape).lineTo(262.82, 212.14598);
        ((GeneralPath) shape).lineTo(262.275, 212.14598);
        ((GeneralPath) shape).lineTo(262.275, 208.411);
        g.setPaint(paint);
        g.fill(shape);
        ...
        paint = new Color(35, 31, 32, 255);
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(267.891, 208.81);
        ((GeneralPath) shape).curveTo(267.461, 208.81, 267.185, 208.899,
                267.056, 209.081);
        ((GeneralPath) shape).curveTo(266.93, 209.26099, 266.865, 209.657,
                266.865, 210.26999);
        ((GeneralPath) shape).curveTo(266.865, 210.887, 266.92798, 211.28699,
                267.056, 211.471);
        ((GeneralPath) shape).curveTo(267.183, 211.65399, 267.461, 211.74599,
                267.891, 211.74599);
        ((GeneralPath) shape).curveTo(268.324, 211.74599, 268.61, 211.64598,
                268.748, 211.443);
        ((GeneralPath) shape).curveTo(268.88498, 211.24199, 268.95398,
                210.82199, 268.95398, 210.18399);
        ((GeneralPath) shape).curveTo(268.95398, 209.62099, 268.887, 209.25198,
                268.748, 209.075);
        ((GeneralPath) shape).curveTo(268.611, 208.899, 268.325, 208.81,
                267.891, 208.81);
        ((GeneralPath) shape).moveTo(269.517, 208.411);
        ((GeneralPath) shape).lineTo(269.517, 212.388);
        ((GeneralPath) shape).curveTo(269.517, 212.929, 269.399, 213.302,
                269.165, 213.505);
        ((GeneralPath) shape).curveTo(268.931, 213.70801, 268.502, 213.81,
                267.87802, 213.81);
        ((GeneralPath) shape).curveTo(267.32303, 213.81, 266.94302, 213.724,
                266.74002, 213.552);
        ((GeneralPath) shape).curveTo(266.53702, 213.38, 266.43503, 213.06,
                266.43503, 212.587);
        ((GeneralPath) shape).lineTo(266.96103, 212.587);
        ((GeneralPath) shape).curveTo(266.96103, 212.90701, 267.02002, 213.114,
                267.13904, 213.212);
        ((GeneralPath) shape).curveTo(267.25604, 213.308, 267.51505, 213.35701,
                267.91605, 213.35701);
        ((GeneralPath) shape).curveTo(268.33203, 213.35701, 268.61005, 213.294,
                268.75504, 213.169);
        ((GeneralPath) shape).curveTo(268.89804, 213.044, 268.96902, 212.8,
                268.96902, 212.43501);
        ((GeneralPath) shape).lineTo(268.96902, 211.68501);
        ((GeneralPath) shape).lineTo(268.95804, 211.68102);
        ((GeneralPath) shape).curveTo(268.81705, 212.02701, 268.41205,
                212.20102, 267.74103, 212.20102);
        ((GeneralPath) shape).curveTo(267.19104, 212.20102, 266.81104,
                212.06602, 266.60202, 211.79301);
        ((GeneralPath) shape).curveTo(266.39603, 211.52202, 266.29, 211.02501,
                266.29, 210.30301);
        ((GeneralPath) shape).curveTo(266.29, 209.557, 266.39502, 209.04501,
                266.607, 208.77);
        ((GeneralPath) shape).curveTo(266.818, 208.49701, 267.211, 208.358,
                267.787, 208.358);
        ((GeneralPath) shape).curveTo(268.396, 208.358, 268.797, 208.546,
                268.983, 208.921);
        ((GeneralPath) shape).lineTo(268.995, 208.917);
        ((GeneralPath) shape).lineTo(268.968, 208.414);
        ((GeneralPath) shape).lineTo(269.517, 208.414);
        g.setPaint(paint);
        g.fill(shape);
        ...
        paint = new Color(35, 31, 32, 255);
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(271.016, 208.411);
        ((GeneralPath) shape).lineTo(271.016, 212.14499);
        ((GeneralPath) shape).lineTo(270.47, 212.14499);
        ((GeneralPath) shape).lineTo(270.47, 208.411);
        ((GeneralPath) shape).lineTo(271.016, 208.411);
        ((GeneralPath) shape).moveTo(271.016, 206.813);
        ((GeneralPath) shape).lineTo(271.016, 207.427);
        ((GeneralPath) shape).lineTo(270.47, 207.427);
        ((GeneralPath) shape).lineTo(270.47, 206.813);
        ((GeneralPath) shape).lineTo(271.016, 206.813);
        g.setPaint(paint);
        g.fill(shape);
        ...
        paint = new Color(35, 31, 32, 255);
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(271.972, 208.411);
        ((GeneralPath) shape).lineTo(272.498, 208.411);
        ((GeneralPath) shape).lineTo(272.482, 208.91899);
        ((GeneralPath) shape).lineTo(272.498, 208.93098);
        ((GeneralPath) shape).curveTo(272.66397, 208.54799, 273.077, 208.35698,
                273.73798, 208.35698);
        ((GeneralPath) shape).curveTo(274.27, 208.35698, 274.63098, 208.45097,
                274.81998, 208.63799);
        ((GeneralPath) shape).curveTo(275.007, 208.82599, 275.102, 209.18498,
                275.102, 209.71599);
        ((GeneralPath) shape).lineTo(275.102, 212.14598);
        ((GeneralPath) shape).lineTo(274.556, 212.14598);
        ((GeneralPath) shape).lineTo(274.556, 209.62299);
        ((GeneralPath) shape).curveTo(274.556, 209.30298, 274.495, 209.08798,
                274.373, 208.97598);
        ((GeneralPath) shape).curveTo(274.25198, 208.86699, 274.016, 208.80998,
                273.667, 208.80998);
        ((GeneralPath) shape).curveTo(272.9, 208.80998, 272.517, 209.17299,
                272.517, 209.89899);
        ((GeneralPath) shape).lineTo(272.517, 212.14598);
        ((GeneralPath) shape).lineTo(271.971, 212.14598);
        ((GeneralPath) shape).lineTo(271.971, 208.411);
        g.setPaint(paint);
        g.fill(shape);
        ...
        paint = new Color(35, 31, 32, 255);
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(278.686, 209.954);
        ((GeneralPath) shape).lineTo(278.682, 209.77899);
        ((GeneralPath) shape).curveTo(278.682, 209.377, 278.616, 209.11299,
                278.483, 208.991);
        ((GeneralPath) shape).curveTo(278.35, 208.87, 278.066, 208.81, 277.626,
                208.81);
        ((GeneralPath) shape).curveTo(277.186, 208.81, 276.898, 208.88,
                276.767, 209.022);
        ((GeneralPath) shape).curveTo(276.636, 209.16301, 276.57, 209.474,
                276.57, 209.95401);
        ((GeneralPath) shape).lineTo(278.686, 209.95401);
        ((GeneralPath) shape).moveTo(278.686, 211.017);
        ((GeneralPath) shape).lineTo(279.24402, 211.017);
        ((GeneralPath) shape).lineTo(279.24802, 211.15399);
        ((GeneralPath) shape).curveTo(279.24802, 211.54, 279.131, 211.812,
                278.894, 211.96799);
        ((GeneralPath) shape).curveTo(278.661, 212.12299, 278.24802, 212.20099,
                277.657, 212.20099);
        ((GeneralPath) shape).curveTo(276.97, 212.20099, 276.52002, 212.07599,
                276.30502, 211.82399);
        ((GeneralPath) shape).curveTo(276.09103, 211.57399, 275.984, 211.04498,
                275.984, 210.23999);
        ((GeneralPath) shape).curveTo(275.984, 209.49599, 276.091, 208.99599,
                276.307, 208.73999);
        ((GeneralPath) shape).curveTo(276.522, 208.486, 276.945, 208.357,
                277.575, 208.357);
        ((GeneralPath) shape).curveTo(278.26202, 208.357, 278.71002, 208.46599,
                278.924, 208.689);
        ((GeneralPath) shape).curveTo(279.13702, 208.90999, 279.24402, 209.377,
                279.24402, 210.088);
        ((GeneralPath) shape).lineTo(279.24402, 210.381);
        ((GeneralPath) shape).lineTo(276.561, 210.381);
        ((GeneralPath) shape).curveTo(276.561, 210.968, 276.624, 211.343,
                276.75, 211.506);
        ((GeneralPath) shape).curveTo(276.874, 211.666, 277.169, 211.748,
                277.633, 211.748);
        ((GeneralPath) shape).curveTo(278.07098, 211.748, 278.356, 211.71,
                278.488, 211.632);
        ((GeneralPath) shape).curveTo(278.61902, 211.556, 278.685, 211.39,
                278.685, 211.134);
        ((GeneralPath) shape).lineTo(278.685, 211.017);
        g.setPaint(paint);
        g.fill(shape);
        ...
        paint = new Color(35, 31, 32, 255);
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(286.438, 206.813);
        ((GeneralPath) shape).lineTo(286.438, 212.146);
        ((GeneralPath) shape).lineTo(285.837, 212.146);
        ((GeneralPath) shape).lineTo(285.837, 209.673);
        ((GeneralPath) shape).lineTo(282.726, 209.673);
        ((GeneralPath) shape).lineTo(282.726, 212.146);
        ((GeneralPath) shape).lineTo(282.125, 212.146);
        ((GeneralPath) shape).lineTo(282.125, 206.813);
        ((GeneralPath) shape).lineTo(282.726, 206.813);
        ((GeneralPath) shape).lineTo(282.726, 209.165);
        ((GeneralPath) shape).lineTo(285.837, 209.165);
        ((GeneralPath) shape).lineTo(285.837, 206.813);
        ((GeneralPath) shape).lineTo(286.438, 206.813);
        g.setPaint(paint);
        g.fill(shape);
        ...
        paint = new Color(35, 31, 32, 255);
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(287.971, 208.411);
        ((GeneralPath) shape).lineTo(287.971, 212.14499);
        ((GeneralPath) shape).lineTo(287.42502, 212.14499);
        ((GeneralPath) shape).lineTo(287.42502, 208.411);
        ((GeneralPath) shape).lineTo(287.971, 208.411);
        ((GeneralPath) shape).moveTo(287.971, 206.813);
        ((GeneralPath) shape).lineTo(287.971, 207.427);
        ((GeneralPath) shape).lineTo(287.42502, 207.427);
        ((GeneralPath) shape).lineTo(287.42502, 206.813);
        ((GeneralPath) shape).lineTo(287.971, 206.813);
        g.setPaint(paint);
        g.fill(shape);
        ...
        paint = new Color(35, 31, 32, 255);
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(290.903, 208.411);
        ((GeneralPath) shape).lineTo(290.903, 208.864);
        ((GeneralPath) shape).lineTo(289.467, 208.864);
        ((GeneralPath) shape).lineTo(289.467, 211.149);
        ((GeneralPath) shape).curveTo(289.467, 211.548, 289.643, 211.74701,
                289.997, 211.74701);
        ((GeneralPath) shape).curveTo(290.349, 211.74701, 290.52402, 211.56902,
                290.52402, 211.212);
        ((GeneralPath) shape).lineTo(290.527, 211.028);
        ((GeneralPath) shape).lineTo(290.535, 210.821);
        ((GeneralPath) shape).lineTo(291.042, 210.821);
        ((GeneralPath) shape).lineTo(291.047, 211.09799);
        ((GeneralPath) shape).curveTo(291.047, 211.83199, 290.699, 212.2,
                290.001, 212.2);
        ((GeneralPath) shape).curveTo(289.282, 212.2, 288.92102, 211.895,
                288.92102, 211.282);
        ((GeneralPath) shape).lineTo(288.92102, 208.864);
        ((GeneralPath) shape).lineTo(288.407, 208.864);
        ((GeneralPath) shape).lineTo(288.407, 208.411);
        ((GeneralPath) shape).lineTo(288.92102, 208.411);
        ((GeneralPath) shape).lineTo(288.92102, 207.513);
        ((GeneralPath) shape).lineTo(289.467, 207.513);
        ((GeneralPath) shape).lineTo(289.467, 208.411);
        ((GeneralPath) shape).lineTo(290.903, 208.411);
        g.setPaint(paint);
        g.fill(shape);
    ...
    private static void paint2(Graphics2D g, Shape clip_,
        ...
        g.transform(new AffineTransform(0.1500059962272644f, 0.0f, 0.0f,
                -0.12687987089157104f, -102.84355163574219f, 844.3499145507812f));
