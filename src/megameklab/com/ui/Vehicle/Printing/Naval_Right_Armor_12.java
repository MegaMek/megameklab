 ...
 */
public class Naval_Right_Armor_12 {
    /**
...
((GeneralPath)shape).curveTo(568.994, 323.087, 567.669, 321.761, 566.035, 321.761);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
((GeneralPath)shape).curveTo(568.994, 196.298, 567.669, 194.973, 566.035, 194.973);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
((GeneralPath)shape).curveTo(555.646, 321.742, 554.32, 323.06702, 554.32, 324.703);
...
((GeneralPath)shape).curveTo(560.24097, 323.066, 558.914, 321.742, 557.282, 321.742);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
((GeneralPath)shape).curveTo(538.14, 449.045, 536.815, 450.37003, 536.815, 452.00702);
...
((GeneralPath)shape).curveTo(542.736, 450.37, 541.409, 449.045, 539.775, 449.045);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
((GeneralPath)shape).curveTo(536.815, 326.621, 538.14, 327.945, 539.775, 327.945);
((GeneralPath)shape).curveTo(541.409, 327.945, 542.736, 326.621, 542.736, 324.983);
...
((GeneralPath)shape).curveTo(546.893, 449.045, 545.568, 450.37003, 545.568, 452.00702);
...
((GeneralPath)shape).curveTo(551.488, 450.37, 550.161, 449.045, 548.528, 449.045);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
((GeneralPath)shape).curveTo(545.568, 326.621, 546.893, 327.945, 548.528, 327.945);
((GeneralPath)shape).curveTo(550.161, 327.945, 551.48804, 326.621, 551.48804, 324.983);
...
((GeneralPath)shape).curveTo(568.994, 449.875, 567.669, 448.549, 566.035, 448.549);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
