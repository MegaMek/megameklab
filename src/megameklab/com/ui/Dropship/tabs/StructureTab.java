...
/**
 * Structure tab for small craft and dropships
 * 
 * @author Neoancient
 *
 */
public class StructureTab extends ITab implements AeroBuildListener {
     ...
     * 
     */
    private static final long serialVersionUID = 1273721610048191812L;
    ...
    private void setUpPanels() {
        ...
        panBasicInfo = new BasicInfoView(getAero().getConstructionTechAdvancement());
        panChassis = new FighterChassisView(panBasicInfo);
        panArmor = new MVFArmorView(panBasicInfo);
        panMovement = new MovementView(panBasicInfo);
        panFuel = new AeroFuelView();
        panHeat = new HeatSinkView(panBasicInfo);
        panArmorAllocation = new ArmorAllocationView(panBasicInfo, Entity.ETYPE_AERO);
    ...
    public void refresh() {
        ...
        panBasicInfo.setFromEntity(getAero());
    ...
    public void updateTechLevel() {
        removeAllListeners();
        getAero().setTechLevel(panBasicInfo.getTechLevel().getCompoundTechLevel(panBasicInfo.useClanTechBase()));
        ...
        if (UnitUtil.checkEquipmentByTechLevel(getAero(), panBasicInfo)) {
