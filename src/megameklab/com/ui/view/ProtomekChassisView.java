...
public class ProtomekChassisView extends BuildView implements ActionListener, ChangeListener {
    ...
    public ProtomekChassisView(ITechManager techManager) {
        ...
        // Get the equipment based on the correct flags rather than relying on magic
        // String literals.
    ...
    public void refresh() {
        ...
        chkMagneticClamps.setVisible((null != magneticClamps) && (getMotiveType() == MOTIVE_TYPE_BIPED)
