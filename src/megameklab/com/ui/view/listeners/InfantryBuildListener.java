...
public interface InfantryBuildListener extends BuildListener {
     ...
     * @param alt        If motiveType is VTOL or INF_UMU, alt is true for microlite
     *                   and motorized scuba respectively, false for microcopter and
     *                   foot scuba. It has no meaning for other motive types.
     */
