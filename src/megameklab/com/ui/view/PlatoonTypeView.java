...
/**
 * Infantry structure tab panel for selecting platoon movement type and
 * number/size of squads.
 *
 * @author Neoancient
 *
 */
public class PlatoonTypeView extends BuildView implements ActionListener, ChangeListener {
    ...
    public static final EntityMovementMode[] MOVEMENT_MODES = { EntityMovementMode.INF_LEG, EntityMovementMode.INF_JUMP,
            EntityMovementMode.INF_MOTORIZED, EntityMovementMode.HOVER, EntityMovementMode.TRACKED,
            EntityMovementMode.WHEELED, EntityMovementMode.VTOL, EntityMovementMode.VTOL, EntityMovementMode.INF_UMU,
            EntityMovementMode.INF_UMU, EntityMovementMode.SUBMARINE };
