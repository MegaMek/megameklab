...
//	private static final String ID_FLUFF_IMAGE = "imageFluff";
	private static final String ID_PLATOON_NAME = "platoon_name";
	private static final String ID_ARMOR_KIT = "armor_kit";
	private static final String ID_ARMOR_DIVISOR = "armor_divisor";
	private static final String ID_SOLDIER = "soldier_";
	private static final String ID_NO_SOLDIER = "no_soldier_";
	private static final String ID_DAMAGE = "damage_";
	private static final String ID_RANGE_MOD = "range_mod_";
	private static final String ID_UW_LABEL = "uw_range_modifier";
	private static final String ID_UW_RANGE_MOD = "uw_range_mod_";
	private static final String ID_FIELD_GUN_COLUMNS = "field_gun_columns";
	private static final String ID_FIELD_GUN_QTY = "field_gun_qty";
	private static final String ID_FIELD_GUN_TYPE = "field_gun_type";
	private static final String ID_FIELD_GUN_DMG = "field_gun_dmg";
	private static final String ID_FIELD_GUN_MIN_RANGE = "field_gun_min_range";
	private static final String ID_FIELD_GUN_SHORT = "field_gun_short";
	private static final String ID_FIELD_GUN_MED = "field_gun_med";
	private static final String ID_FIELD_GUN_LONG = "field_gun_long";
	private static final String ID_FIELD_GUN_AMMO = "field_gun_ammo";
	private static final String ID_FIELD_GUN_CREW = "field_gun_crew";
	private static final String ID_DEST_MODS = "dest_mods";
	private static final String ID_SNEAK_CAMO_MODS = "sneak_camo_mods";
	private static final String ID_SNEAK_IR_MODS = "sneak_ir_mods";
	private static final String ID_BV = "bv";
	private static final String ID_TRANSPORT_WT = "transport_wt";
	private static final String ID_MP_1 = "mp_1";
	private static final String ID_MODE_1 = "movement_mode_1";
	private static final String ID_MP_2 = "mp_2";
	private static final String ID_MODE_2 = "movement_mode_2";
	private static final String ID_NOTES = "notes";
	private static final String ID_NOTE_LINE = "note_line_";
