...
public class EquipmentTab extends ITab implements ActionListener {
    ...
    private void filterEquipment() {
        ...
        equipmentTypeFilter = new RowFilter<EquipmentTableModel, Integer>() {
            ...
            public boolean include(Entry<? extends EquipmentTableModel, ? extends Integer> entry) {
                ...
                if ((etype instanceof MiscType) && (etype.hasFlag(MiscType.F_BA_MANIPULATOR)
                        || etype.hasFlag(MiscType.F_PARTIAL_WING) || etype.hasFlag(MiscType.F_JUMP_BOOSTER)
                        || etype.hasFlag(MiscType.F_MECHANICAL_JUMP_BOOSTER) || etype.hasFlag(MiscType.F_MASC))) {
                    return false;
                }

                if (etype.hasFlag(MiscType.F_DETACHABLE_WEAPON_PACK) && !getBattleArmor().canMountDWP()) {
                    return false;
                }
                ...
                if (((nType == T_OTHER) && UnitUtil.isUnitEquipment(etype, ba))
                    ...
                    if (eSource.getTechManager() != null && !eSource.getTechManager().isLegal(etype)
    ...
    /**
     * A comparator for weights that have been formatted with DecimalFormat and may
     * require conversion from kg to tons.
     *
     */
