...
stroke = new BasicStroke(0.5057f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(377.195, 235.428);
((GeneralPath)shape).curveTo(377.195, 236.872, 376.023, 238.04599, 374.57602, 238.04599);
((GeneralPath)shape).curveTo(373.12903, 238.04599, 371.958, 236.872, 371.958, 235.428);
((GeneralPath)shape).curveTo(371.958, 233.98, 373.129, 232.80899, 374.57602, 232.80899);
((GeneralPath)shape).curveTo(376.02304, 232.80899, 377.195, 233.98, 377.195, 235.428);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.5057f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(384.195, 235.428);
((GeneralPath)shape).curveTo(384.195, 236.872, 383.023, 238.04599, 381.57602, 238.04599);
((GeneralPath)shape).curveTo(380.12903, 238.04599, 378.958, 236.872, 378.958, 235.428);
((GeneralPath)shape).curveTo(378.958, 233.98, 380.129, 232.80899, 381.57602, 232.80899);
((GeneralPath)shape).curveTo(383.02304, 232.80899, 384.195, 233.98, 384.195, 235.428);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
