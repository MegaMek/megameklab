 ...
 */
public class Armor_CT_8_Humanoid {
    /**
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(496.831, 136.37);
((GeneralPath)shape).curveTo(498.14398, 136.37, 499.24298, 135.273, 499.24298, 133.956);
((GeneralPath)shape).curveTo(499.24298, 132.56499, 498.14297, 131.541, 496.831, 131.541);
((GeneralPath)shape).curveTo(495.511, 131.541, 494.414, 132.565, 494.414, 133.956);
((GeneralPath)shape).curveTo(494.414, 135.272, 495.511, 136.37, 496.831, 136.37);
((GeneralPath)shape).lineTo(496.831, 136.37);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(486.043, 136.37);
((GeneralPath)shape).curveTo(487.359, 136.37, 488.458, 135.273, 488.458, 133.956);
((GeneralPath)shape).curveTo(488.458, 132.56499, 487.359, 131.541, 486.043, 131.541);
((GeneralPath)shape).curveTo(484.726, 131.541, 483.627, 132.565, 483.627, 133.956);
((GeneralPath)shape).curveTo(483.627, 135.272, 484.726, 136.37, 486.043, 136.37);
((GeneralPath)shape).lineTo(486.043, 136.37);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(496.831, 156.932);
((GeneralPath)shape).curveTo(498.14398, 156.932, 499.24298, 155.835, 499.24298, 154.518);
((GeneralPath)shape).curveTo(499.24298, 153.127, 498.14297, 152.10301, 496.831, 152.10301);
((GeneralPath)shape).curveTo(495.511, 152.10301, 494.414, 153.12701, 494.414, 154.518);
((GeneralPath)shape).curveTo(494.414, 155.835, 495.511, 156.932, 496.831, 156.932);
((GeneralPath)shape).lineTo(496.831, 156.932);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(486.043, 156.932);
((GeneralPath)shape).curveTo(487.359, 156.932, 488.458, 155.835, 488.458, 154.518);
((GeneralPath)shape).curveTo(488.458, 153.127, 487.359, 152.10301, 486.043, 152.10301);
((GeneralPath)shape).curveTo(484.726, 152.10301, 483.627, 153.12701, 483.627, 154.518);
((GeneralPath)shape).curveTo(483.627, 155.835, 484.726, 156.932, 486.043, 156.932);
((GeneralPath)shape).lineTo(486.043, 156.932);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
