 ...
 */
public class Armor_LLeg_1_Humanoid {
    /**
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(450.451, 241.283);
((GeneralPath)shape).curveTo(448.88898, 240.894, 447.927, 239.29901, 448.335, 237.664);
((GeneralPath)shape).curveTo(448.724, 236.102, 450.322, 235.143, 451.88498, 235.533);
((GeneralPath)shape).curveTo(453.51498, 235.938, 454.47397, 237.53601, 454.085, 239.09601);
((GeneralPath)shape).curveTo(453.677, 240.731, 452.081, 241.689, 450.451, 241.283);
((GeneralPath)shape).lineTo(450.451, 241.283);
