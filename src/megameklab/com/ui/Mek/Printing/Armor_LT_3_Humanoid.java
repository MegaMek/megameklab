 ...
 */
public class Armor_LT_3_Humanoid {
    /**
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(456.988, 103.18);
((GeneralPath)shape).curveTo(455.67102, 103.18, 454.574, 104.278, 454.574, 105.595);
((GeneralPath)shape).curveTo(454.574, 106.912, 455.671, 108.01, 456.988, 108.01);
((GeneralPath)shape).curveTo(458.303, 108.01, 459.403, 106.913, 459.403, 105.595);
((GeneralPath)shape).curveTo(459.403, 104.278, 458.305, 103.18, 456.988, 103.18);
((GeneralPath)shape).lineTo(456.988, 103.18);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(467.3, 138.884);
((GeneralPath)shape).curveTo(465.97897, 138.884, 464.883, 137.786, 464.883, 136.46901);
((GeneralPath)shape).curveTo(464.883, 135.15201, 465.979, 134.05501, 467.3, 134.05501);
((GeneralPath)shape).curveTo(468.616, 134.05501, 469.71198, 135.15201, 469.71198, 136.46901);
((GeneralPath)shape).curveTo(469.712, 137.786, 468.616, 138.884, 467.3, 138.884);
((GeneralPath)shape).lineTo(467.3, 138.884);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
