 ...
 */
public class Armor_CT_30_Humanoid {
    /**
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(480.648, 185.962);
((GeneralPath)shape).curveTo(482.039, 185.962, 483.06, 184.863, 483.06, 183.54701);
((GeneralPath)shape).curveTo(483.06, 182.23102, 482.039, 181.13301, 480.648, 181.13301);
((GeneralPath)shape).curveTo(479.33102, 181.13301, 478.234, 182.23102, 478.234, 183.54701);
((GeneralPath)shape).curveTo(478.234, 184.863, 479.331, 185.962, 480.648, 185.962);
((GeneralPath)shape).lineTo(480.648, 185.962);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(502.223, 185.962);
((GeneralPath)shape).curveTo(503.611, 185.962, 504.63498, 184.863, 504.63498, 183.54701);
((GeneralPath)shape).curveTo(504.63498, 182.23102, 503.611, 181.13301, 502.223, 181.13301);
((GeneralPath)shape).curveTo(500.906, 181.13301, 499.806, 182.23102, 499.806, 183.54701);
((GeneralPath)shape).curveTo(499.806, 184.863, 500.905, 185.962, 502.223, 185.962);
((GeneralPath)shape).lineTo(502.223, 185.962);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(491.436, 185.962);
((GeneralPath)shape).curveTo(492.824, 185.962, 493.848, 184.863, 493.848, 183.54701);
((GeneralPath)shape).curveTo(493.848, 182.23102, 492.824, 181.13301, 491.436, 181.13301);
((GeneralPath)shape).curveTo(490.11902, 181.13301, 489.019, 182.23102, 489.019, 183.54701);
((GeneralPath)shape).curveTo(489.019, 184.863, 490.118, 185.962, 491.436, 185.962);
((GeneralPath)shape).lineTo(491.436, 185.962);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
