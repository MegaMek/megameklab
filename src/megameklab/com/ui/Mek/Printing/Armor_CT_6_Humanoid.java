 ...
 */
public class Armor_CT_6_Humanoid {
    /**
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(496.831, 146.651);
((GeneralPath)shape).curveTo(498.14398, 146.651, 499.24298, 145.554, 499.24298, 144.237);
((GeneralPath)shape).curveTo(499.24298, 142.846, 498.14297, 141.822, 496.831, 141.822);
((GeneralPath)shape).curveTo(495.511, 141.822, 494.414, 142.84601, 494.414, 144.237);
((GeneralPath)shape).curveTo(494.414, 145.554, 495.511, 146.651, 496.831, 146.651);
((GeneralPath)shape).lineTo(496.831, 146.651);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(486.043, 146.651);
((GeneralPath)shape).curveTo(487.359, 146.651, 488.458, 145.554, 488.458, 144.237);
((GeneralPath)shape).curveTo(488.458, 142.846, 487.359, 141.822, 486.043, 141.822);
((GeneralPath)shape).curveTo(484.726, 141.822, 483.627, 142.84601, 483.627, 144.237);
((GeneralPath)shape).curveTo(483.627, 145.554, 484.726, 146.651, 486.043, 146.651);
((GeneralPath)shape).lineTo(486.043, 146.651);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
