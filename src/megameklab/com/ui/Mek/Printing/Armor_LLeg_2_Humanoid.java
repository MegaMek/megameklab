 ...
 */
public class Armor_LLeg_2_Humanoid {
    /**
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(456.514, 216.961);
((GeneralPath)shape).curveTo(454.953, 216.571, 453.993, 214.975, 454.398, 213.342);
((GeneralPath)shape).curveTo(454.789, 211.77899, 456.385, 210.821, 457.948, 211.211);
((GeneralPath)shape).curveTo(459.579, 211.617, 460.539, 213.214, 460.148, 214.776);
((GeneralPath)shape).curveTo(459.742, 216.408, 458.143, 217.368, 456.514, 216.961);
((GeneralPath)shape).lineTo(456.514, 216.961);
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(444.384, 265.605);
((GeneralPath)shape).curveTo(442.821, 265.215, 441.863, 263.621, 442.271, 261.98602);
((GeneralPath)shape).curveTo(442.66, 260.424, 444.258, 259.46503, 445.82098, 259.855);
((GeneralPath)shape).curveTo(447.448, 260.26202, 448.40997, 261.858, 448.021, 263.42);
((GeneralPath)shape).curveTo(447.613, 265.054, 446.017, 266.012, 444.384, 265.605);
((GeneralPath)shape).lineTo(444.384, 265.605);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
