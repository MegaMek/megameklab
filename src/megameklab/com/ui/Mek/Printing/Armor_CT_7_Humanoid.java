 ...
 */
public class Armor_CT_7_Humanoid {
    /**
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(480.648, 146.651);
((GeneralPath)shape).curveTo(482.039, 146.651, 483.06, 145.552, 483.06, 144.23601);
((GeneralPath)shape).curveTo(483.06, 142.92001, 482.039, 141.822, 480.648, 141.822);
((GeneralPath)shape).curveTo(479.33102, 141.822, 478.234, 142.92001, 478.234, 144.23601);
((GeneralPath)shape).curveTo(478.234, 145.552, 479.331, 146.651, 480.648, 146.651);
((GeneralPath)shape).lineTo(480.648, 146.651);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(502.223, 146.651);
((GeneralPath)shape).curveTo(503.611, 146.651, 504.63498, 145.552, 504.63498, 144.23601);
((GeneralPath)shape).curveTo(504.63498, 142.92001, 503.611, 141.822, 502.223, 141.822);
((GeneralPath)shape).curveTo(500.906, 141.822, 499.806, 142.92001, 499.806, 144.23601);
((GeneralPath)shape).curveTo(499.806, 145.552, 500.905, 146.651, 502.223, 146.651);
((GeneralPath)shape).lineTo(502.223, 146.651);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(0.504f,0,0,2.4142f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(491.436, 146.651);
((GeneralPath)shape).curveTo(492.824, 146.651, 493.848, 145.552, 493.848, 144.23601);
((GeneralPath)shape).curveTo(493.848, 142.92001, 492.824, 141.822, 491.436, 141.822);
((GeneralPath)shape).curveTo(490.11902, 141.822, 489.019, 142.92001, 489.019, 144.23601);
((GeneralPath)shape).curveTo(489.019, 145.552, 490.118, 146.651, 491.436, 146.651);
((GeneralPath)shape).lineTo(491.436, 146.651);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
