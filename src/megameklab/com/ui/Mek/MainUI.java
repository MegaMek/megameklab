...
public class MainUI extends JFrame implements RefreshListener {
    ...
    private static final String VERSION = "0.0.0.15-Dev-104";
    ...
    public MainUI() {
         ...
         * 
         * item = new JMenuItem("Current Unit"); item.setMnemonic('C');
         ...
         * 
         * item = new JMenuItem("From MUL"); item.setMnemonic('F');
         * item.addActionListener(new ActionListener() { public void
         * actionPerformed(ActionEvent e) {
         * jMenuPrintAdvancedMulMechs_actionPerformed(e); } });
         * advancedRecordSheet.add(item); printMenu.add(advancedRecordSheet);
         */
