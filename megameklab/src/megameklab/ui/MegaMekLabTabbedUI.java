...
public class MegaMekLabTabbedUI extends JFrame implements MenuBarOwner, ChangeListener {
    ...
    private JButton createNewButton() {
        ...
        button.setToolTipText("Create new unit");
    ...
    private JButton createOpenButton() {
        ...
        button.setToolTipText("Open existing unit");
        button.setFocusable(false);
        button.setBorderPainted(false);
        button.setContentAreaFilled(false);
        button.addMouseListener(new MouseAdapter() {
    ...
    private void newUnit(long type, boolean primitive, boolean industrial) {
        ...
        // tabs.setTabComponentAt(tabs.getSelectedIndex(), new
        // EditorTab(newUi.getEntity().getDisplayName(), newUi));
