...
public class DSChassisView extends BuildView implements ActionListener, ChangeListener {
    ...
    public void initUI() {
        ...
        add(createLabel(resourceMap,
              "lblTonnage",
              "DropshipChassisView.spnTonnage.text",
        ...
        add(createLabel(resourceMap,
              "lblBaseType",
              "DropshipChassisView.cbBaseType.text",
        ...
        add(createLabel(resourceMap,
              "lblChassisType",
              "DropshipChassisView.cbChassisType.text",
        ...
        gbc.gridy = 4;
        gbc.gridwidth = 1;
        add(createLabel(resourceMap, "lblSI", "DropshipChassisView.spnSI.text", "DropshipChassisView.spnSI.tooltip"),
              gbc);
        gbc.gridx = 1;
        gbc.gridy = 4;
        gbc.gridwidth = 3;
