...
public class LACrewView extends BuildView implements ActionListener, ChangeListener {
    ...
    public void initUI() {
        ...
        add(createLabel(resourceMap,
              "lblBaseCrew",
              "AerospaceCrewView.spnBaseCrew.text",
        ...
        add(createLabel(resourceMap,
              "lblGunners",
              "AerospaceCrewView.spnGunners.text",
        ...
        add(createLabel(resourceMap,
              "lblOfficers",
              "AerospaceCrewView.spnOfficers.text",
        ...
        add(createLabel(resourceMap,
              "lblBayPersonnel",
              "AerospaceCrewView.lblBayPersonnel.text",
        ...
        add(createLabel(resourceMap,
              "lblPassengers",
              "AerospaceCrewView.spnPassengers.text",
        ...
        add(createLabel(resourceMap,
              "lblMarines",
              "AerospaceCrewView.spnMarines.text",
        ...
        gbc.gridwidth = 1;
        add(createLabel(resourceMap,
              "lblQuartersFirstClass",
              "AerospaceCrewView.spnQuartersFirstClass.text",
        ...
        add(createLabel(resourceMap,
              "lblQuartersStandard",
              "AerospaceCrewView.spnQuartersStandard.text",
        ...
        gbc.gridy++;
        add(createLabel(resourceMap,
              "lblQuartersSecondClass",
              "AerospaceCrewView.spnQuartersSecondClass.text",
        ...
        add(createLabel(resourceMap,
              "lblQuartersSteerage",
              "AerospaceCrewView.spnQuartersSteerage.text",
        ...
        add(createLabel(resourceMap,
              "lblLifeBoats",
              "AerospaceCrewView.spnLifeBoats.text",
        ...
        add(createLabel(resourceMap,
              "lblEscapePods",
              "AerospaceCrewView.spnEscapePods.text",
