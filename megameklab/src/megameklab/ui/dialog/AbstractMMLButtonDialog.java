...
/**
 * This is the Base Dialog for a dialog with buttons in MML. It extends Base Dialog, and adds a button panel with base
 * Ok and Cancel buttons. It also includes an enum tracker for the result of the dialog.
 * <p>
