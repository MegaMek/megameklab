...
/**
 * An Equipment Database for Combat Vehicles. This table shows only a few columns and is suitable for use in a detached
 * dialog.
 */
class CVFloatingEquipmentDatabaseView extends CVEquipmentDatabaseView {
    ...
    public CVFloatingEquipmentDatabaseView(EntitySource eSource) {
        super(eSource);
    }
