...
/**
 * An Equipment Database for Aerospace and Conventional Fighters. This table shows only a few columns and is suitable
 * for use in a detached dialog.
 */
class ASFloatingEquipmentDatabaseView extends ASEquipmentDatabaseView {

    private final List<Integer> columns = List.of(COL_NAME, COL_HEAT, COL_TECH, COL_TON);

    public ASFloatingEquipmentDatabaseView(EntitySource eSource) {
        super(eSource);
    }
