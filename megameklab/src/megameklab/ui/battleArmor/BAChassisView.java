...
public class BAChassisView extends BuildView implements ActionListener, ChangeListener {
    ...
    private void initUI() {
        ...
        add(createLabel(resourceMap,
              "lblChassisType",
              "BAChassisView.cbChassisType.text",
        ...
        add(createLabel(resourceMap,
              "lblWeightClass",
              "BAChassisView.cbWeightClass.text",
        ...
        add(createLabel(resourceMap,
              "lblSquadSize",
              "BAChassisView.spnSquadSize.text",
        ...
        add(createLabel(resourceMap,
              "lblTurretType",
              "BAChassisView.cbTurretType.text",
        ...
        add(createLabel(resourceMap,
              "lblTurretSize",
              "BAChassisView.spnTurretSize.text",
