...
/**
 * An Equipment Database for ProtoMeks. This table shows only few columns and is suitable for use in a detached dialog.
 */
class PMFloatingEquipmentDatabaseView extends PMEquipmentDatabaseView {
