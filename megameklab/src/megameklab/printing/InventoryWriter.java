...
public class InventoryWriter {
        ...
        for (Mounted<?> m : sheet.getEntity().getEquipment()) {
            ...
            if ((m.getType() instanceof AmmoType) &&
                ...
                if (m.getLocation() != Entity.LOC_NONE) {
                    ...
                    // A bit of an ugly hack to get fusillade ammo to show up and identify as fusillade
                    // instead of iATM3
     ...
     * relationship between font size and height not directly proportional, but a smaller reduction may be sufficient to
     * reduce the number of line required for longer fields.
     *
