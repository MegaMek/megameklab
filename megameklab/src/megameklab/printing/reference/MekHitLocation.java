...
public class MekHitLocation extends ReferenceTable {
    ...
    static final String[][] BIPED_LOCATIONS = { { "2*", "LT(C)", "CT(C)", "RT(C)" }, { "3", "LL", "RA", "RL" },
                                                { "4", "LA", "RA", "RA" }, { "5", "LA", "RL", "RA" },
                                                { "6", "LL", "RT", "RL" }, { "7", "LT", "CT", "RT" },
                                                { "8", "CT", "LT", "CT" }, { "9", "RT", "LL", "LT" },
                                                { "10", "RA", "LA", "LA" }, { "11", "RL", "LA", "LL" },
                                                { "12", "HD", "HD", "HD" } };

    static final String[][] QUAD_LOCATIONS = { { "2*", "LT(C)", "CT(C)", "RT(C)" }, { "3", "LRL", "RFL", "RRL" },
                                               { "4", "LFL", "RFL", "RFL" }, { "5", "LFL", "RRL", "RFL" },
                                               { "6", "LRL", "RT", "RRL" }, { "7", "LT", "CT", "RT" },
                                               { "8", "CT", "LT", "CT" }, { "9", "RT", "LRL", "LT" },
                                               { "10", "RFL", "LFL", "LFL" }, { "11", "RRL", "LFL", "LRL" },
                                               { "12", "HD", "HD", "HD" } };

    static final String[][] TRIPOD_LOCATIONS = { { "2*", "LT(C)", "CT(C)", "RT(C)" },
                                                 { "3", "Leg (+1)\u2020", "RA", "Leg (-1)\u2020" },
                                                 { "4", "LA", "RA", "RA" }, { "5", "LA", "Leg\u2020", "RA" },
                                                 { "6", "Leg (+1)\u2020", "RT", "Leg (-1)\u2020" },
                                                 { "7", "LT", "CT", "RT" }, { "8", "CT", "LT", "CT" },
                                                 { "9", "RT", "Leg\u2020", "LT" }, { "10", "RA", "LA", "LA" },
                                                 { "11", "Leg (+1)\u2020", "LA", "Leg (-1)\u2020" },
                                                 { "12", "HD", "HD", "HD" } };
