...
/**
 * Objects of this class can encode a <code>GameTurn</code> object as XML into
...
public class GameTurnEncoder {
     ...
     * 
     * @param option - the <code>GameTurn</code> to be encoded. This value
     ...
     */
    public static void encode(GameTurn option, Writer out) throws IOException {
    }
