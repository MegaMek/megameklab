...
public class MovementDisplay extends StatusBarPhaseDisplay implements
    ...
    public MovementDisplay(ClientGUI clientgui) {
        ...
        butLayMine = new Button(Messages
        ...
        butHullDown = new Button(Messages
        ...
        butClimbMode = new Button(Messages
        ...
        butFortify = new Button(Messages
        ...
        butShakeOff = new Button(Messages
    ...
    private String doPSRCheck(MovePath md) {
        ...
        for (final Enumeration<MoveStep> i = md.getSteps(); i.hasMoreElements();) {
            ...
            if ((step.getType() == MovePath.STEP_BACKWARDS
                    ...
                    && client.game.getBoard().getHex(lastPos).getElevation() != curHex
        ...
        if (b.getType() == BoardViewEvent.BOARD_HEX_DRAGGED && !nopath) {
            ...
            if (shiftheld || gear == MovementDisplay.GEAR_TURN) {
                ...
                if (possible.length() == 0) {
                    butDone
                            .setLabel(Messages
                                    .getString("MovementDisplay.Done")); //$NON-NLS-1$
                }
                return;
            }
...
//      I also want to handle fighter recovery here. If using advanced movement
    ...
    public synchronized void actionPerformed(ActionEvent ev) {
        ...
        if (ev.getSource() == butDone) {
            ...
            if (gear == MovementDisplay.GEAR_JUMP
                    ...
                    || gear == MovementDisplay.GEAR_RAM) { // in the wrong gear
                // clearAllMoves();
            ...
            if (ce instanceof LandAirMech
                    && ((LandAirMech) ce).isInMode(LandAirMech.MODE_AIRMECH)) {
            ...
            clearAllMoves();
            if (ce instanceof LandAirMech) {
                final LandAirMech lam = (LandAirMech) client.getEntity(ce
                        .getId());
    ...
    private void setSearchlightEnabled(boolean enabled, boolean state) {
        if (state)
            butSearchlight.setLabel(Messages
